...
「相手が薄々気づきつつも、目を背け続けている現実を、**”己の実体験・エピソードと、これまでに届いた感想・エピソード”**を軸に突きつけてください。
『僕はこれが闇だと感じている。少なくとも、これまでに届いた周りの人からの相談内容からも、そう結論づけないと論理的に説明がつかない。さて、あなたはどう思う？』
といった**客観的証拠・エピソードを前提に、否が応でも直視せざるを得ない状況を作り出すスタイル**です。」

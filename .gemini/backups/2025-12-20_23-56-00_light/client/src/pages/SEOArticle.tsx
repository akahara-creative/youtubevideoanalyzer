...
export default function SEOArticle() {
  ...
  const [targetWordCount, setTargetWordCount] = useState<number>(5000);
  ...
  const { data: jobStatus } = trpc.seoArticle.getJobStatus.useQuery(
    { jobId: currentJobId! },
    { 
  ...
  const handleLoadHistory = (historyItem: any) => {
    try {
      ...
      const parsedKeywords = typeof historyItem.keywords === 'string' 
        ...
        : Array.isArray(historyItem.keywords) 
